...
"""autogenerated by genpy from franka_interface_msgs/RobotState.msg. Do not edit."""
import codecs
import sys
...
class RobotState(genpy.Message):
  _md5sum = "1bd13b23161f53b273eafd78a98128f7"
  _type = "franka_interface_msgs/RobotState"
...
bool joint_move_in_wrong_direction"""
  ...
  __slots__ = ['header','pose_desired','O_T_EE','O_T_EE_d','F_T_EE','EE_T_K','m_ee','I_ee','F_x_Cee','m_load','I_load','F_x_Cload','m_total','I_total','F_x_Ctotal','elbow','elbow_d','elbow_c','delbow_c','ddelbow_c','tau_J','tau_J_d','dtau_J','q','q_d','dq','dq_d','ddq_d','joint_contact','cartesian_contact','joint_collision','cartesian_collision','tau_ext_hat_filtered','O_F_ext_hat_K','K_F_ext_hat_K','O_dP_EE_d','O_T_EE_c','O_dP_EE_c','O_ddP_EE_c','theta','dtheta','current_errors','last_motion_errors','control_command_success_rate','robot_mode','robot_time','gripper_width','gripper_max_width','gripper_is_grasped','gripper_temperature','gripper_time','is_fresh']
  _slot_types = ['std_msgs/Header','float64[16]','float64[16]','float64[16]','float64[16]','float64[16]','float64','float64[9]','float64[3]','float64','float64[9]','float64[3]','float64','float64[9]','float64[3]','float64[2]','float64[2]','float64[2]','float64[2]','float64[2]','float64[7]','float64[7]','float64[7]','float64[7]','float64[7]','float64[7]','float64[7]','float64[7]','float64[7]','float64[6]','float64[7]','float64[6]','float64[7]','float64[6]','float64[6]','float64[6]','float64[16]','float64[6]','float64[6]','float64[7]','float64[7]','franka_interface_msgs/Errors','franka_interface_msgs/Errors','float64','uint8','float64','float64','float64','bool','uint16','float64','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pose_desired,O_T_EE,O_T_EE_d,F_T_EE,EE_T_K,m_ee,I_ee,F_x_Cee,m_load,I_load,F_x_Cload,m_total,I_total,F_x_Ctotal,elbow,elbow_d,elbow_c,delbow_c,ddelbow_c,tau_J,tau_J_d,dtau_J,q,q_d,dq,dq_d,ddq_d,joint_contact,cartesian_contact,joint_collision,cartesian_collision,tau_ext_hat_filtered,O_F_ext_hat_K,K_F_ext_hat_K,O_dP_EE_d,O_T_EE_c,O_dP_EE_c,O_ddP_EE_c,theta,dtheta,current_errors,last_motion_errors,control_command_success_rate,robot_mode,robot_time,gripper_width,gripper_max_width,gripper_is_grasped,gripper_temperature,gripper_time,is_fresh
    ...
    if args or kwds:
      ...
      if self.pose_desired is None:
        self.pose_desired = [0.] * 16
      ...
      if self.current_errors is None:
        self.current_errors = franka_interface_msgs.msg.Errors()
      if self.last_motion_errors is None:
        self.last_motion_errors = franka_interface_msgs.msg.Errors()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_16d().pack(*self.pose_desired))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.pose_desired = _get_struct_16d().unpack(str[start:end])
      start = end
      end += 128
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      buff.write(self.pose_desired.tostring())
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.pose_desired = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=16)
      start = end
      end += 128
