...
public class HandController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (allowMove)
        {
            ...
            Debug.LogFormat("The raw controller_rotation is:{0}", controller_rotation);
            ...
            else
            {
                ...
                Debug.LogFormat("The goal controller_rotation is:{0}", controller_rotation);
            ...
            {
                OVRInput.SetControllerVibration(1f,2f, OVRInput.Controller.RTouch);
